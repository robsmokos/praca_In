...
def choose_action(action_probs, num_tls, num_phases):
    ...
    for i in range(num_tls):
        ...
        if np.isclose(row_sum, 0.0):
            # Jeśli suma jest zerowa lub bardzo bliska zeru, ustawiamy równomierny rozkład
...
def train_actor_critic():
    ...
    try:
        ...
        for episode in range(30):
            ...
            model.save_weights(f"/content/SUMO/model2/{total_reward}model_epizod_{episode}.weights.h5")
