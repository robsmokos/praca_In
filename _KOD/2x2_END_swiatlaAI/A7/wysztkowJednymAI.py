...
ax2 = ax1.twinx()
ax2.set_ylabel("Zatrzymane pojazdy", color="darkorange")
ln2 = ax2.plot(df_sampled["Krok"], df_sampled["ZatrzymanePojazdy"], color="darkorange", label="Zatrzymane pojazdy")
