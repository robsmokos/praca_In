...
CONFIG_FILE = "/content/drive/MyDrive/PRACA/SUMO/2x2.sumocfg"
...
def train_actor_critic():
    ...
    try:
        ...
        for episode in range(60):
            ...
            model.save_weights(f"/content/drive/MyDrive/PRACA/5/{total_reward}model_epizod_{episode}.weights.h5")
