...
config_file = r"c:\DATA\ROB\7SEM\test\skrzyzowanieX_swiatla\01_skrzyzowanieX.sumocfg"
output_file = r"c:\DATA\ROB\7SEM\test\skrzyzowanieX_swiatla\wynik\out_tripInfo.xml"  # Dodaj rozszerzenie .xml

# Komenda do uruchomienia symulacji SUMO
command = [
    "sumo-gui",  # Użyj "sumo" jeśli chcesz uruchomić bez GUI
    "-c", config_file,
