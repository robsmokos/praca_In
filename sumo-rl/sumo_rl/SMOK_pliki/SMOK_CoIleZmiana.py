        ...
        with open(output_file, mode='w') as output:
            for row in reader:
                ...
                if previous_action is not None and current_action != previous_action:
                    ...
                    output.write(f"{current_time:.1f}: Zmiana swiatła z {previous_action} na {current_action} w czasie {previous_time} do {current_time}. Sygnalizator był w stanie {previous_action} przez {duration:.1f} sekund.\n")
