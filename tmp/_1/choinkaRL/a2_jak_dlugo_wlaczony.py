...
df = pd.read_csv('a1_out__traffic_light_actions.csv')
...
df.to_csv('a2_out_out_jak_dlugo_wlaczone.csv', index=False)

print("Wyniki zostały zapisane do pliku 'a2_out_jak_dlugo_wlaczone.csv'")
