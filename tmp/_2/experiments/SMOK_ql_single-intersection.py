...
def log_traffic_light_data(file_path):
    """Log traffic light data to a file."""
...
if __name__ == "__main__":
    ...
    traffic_light_log_file = f"c:\\DATA\\ROB\\6SEM\\PRACA_DYP\\_2\\outputs\\single-intersection\\traffic_lights_log_{experiment_time}.txt"

    # Uruchomienie symulacji SUMO
    traci.start(["sumo", "-c", "your_config_file.sumocfg"])  # Zamień "your_config_file.sumocfg" na swoją konfigurację
    ...
    for run in range(1, args.runs + 1):
        ...
        # Logowanie danych sygnalizatorów
        log_traffic_light_data(traffic_light_log_file)
