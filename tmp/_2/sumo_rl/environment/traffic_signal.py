...
#SMOK    
    def print_state(self):
        """Prints the current state of the traffic signal."""
        print("Traffic Signal ID:", self.id)
        print("Current Green Phase:", self.green_phase)
        print("Is Yellow Phase:", self.is_yellow)
        print("Time Until Next Action:", self.next_action_time - self.env.sim_step)
